...
import bannerImage from "@/assets/Pricing-cost-calculator/roofing/bannerImage.png";

const CalculatorRoofingBanner = () => {
  return (
      ...
      <div className="absolute bg-black/30 w-full z-10 flex items-center justify-center h-full">
        <div className="container">
          <h2 className="text-white font-bold text-4xl md:text-5xl lg:text-6xl leading-tight">
            Get A Custom Roof <br /> Quote Today
          </h2>
          <p className="text-white mt-8 text-lg max-w-xl">
            Curious what a new roof might cost? Start with a quick,
...
export default CalculatorRoofingBanner;
