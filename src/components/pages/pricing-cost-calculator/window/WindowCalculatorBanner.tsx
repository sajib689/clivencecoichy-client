...
import bannerImage from "@/assets/Pricing-cost-calculator/window/bannerImage.png";

const WindowCalculatorBanner = () => {
  return (
      ...
      <div className="absolute bg-black/30 w-full z-10 flex items-center justify-center h-full">
        <div className="container">
          <h2 className="text-white font-bold text-4xl md:text-5xl lg:text-6xl leading-tight">
            Quick Estimate for <br /> Window Replacement
          </h2>
          <p className="text-white mt-8 text-lg max-w-xl">
            Wondering what new windows might run you? Get a quick, hassle-free
            estimate to start planning.
          </p>
...
export default WindowCalculatorBanner;
